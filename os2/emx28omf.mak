#   TS 980222 / SMS 980705 / AG 990116
#
...
#
#   changed for emx 2.8.1 compiler using 0.9d runtime, implemented
#   static library linking by using "EMXDLL = 0" by Andre Grueneberg
#
...
ifeq "$(CPU)" "586"
coptf= -mpentium -malign-functions=2 -malign-loops=2 -malign-jumps=2 -D_CPU=586
endif

ifeq "$(CPU)" "686"
coptf= -mpentiumpro -malign-functions=2 -malign-loops=2 -malign-jumps=2 -D_CPU=686
endif
...
ADDLIBS= -L../lib -L. $(ADDLIBS1) -lmcp32 -lbinkley

ifeq "$(EMXDLL)" "1"
OPTFLAGS1=-Zomf -Zcrtdll
else
OPTFLAGS1=-Zomf -Zsys
endif

OPTFLAGS=-s -O2 $(OPTFLAGS1) $(coptf)
DBGFLAGS=-g
MTHREADS=-Zmt
...
CFLAGS= -Wall -pedantic -fomit-frame-pointer $(OPTFLAGS) $(DEFFLAGS) $(ADDINCS)
